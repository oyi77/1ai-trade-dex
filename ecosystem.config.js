...
module.exports = {
  apps: [
    ...
    {
      name: 'polyedge-bot-guardian',
      script: path.join(ROOT, 'scripts', 'bot-guardian.sh'),
      cwd: ROOT,
      ...
      autorestart: true,
      log_date_format: 'YYYY-MM-DD HH:mm:ss',
      error_file: path.join(LOG_DIR, 'bot-guardian-error.log'),
      out_file: path.join(LOG_DIR, 'bot-guardian-out.log'),
    },
    {
      name: 'polyedge-mirofish',
      script: path.join(ROOT, '..', 'mirofish', 'venv', 'bin', 'python'),
      args: 'minimal_server.py',
      cwd: path.join(ROOT, '..', 'mirofish'),
      interpreter: 'none',
      watch: false,
      restart_delay: 10000,
      max_restarts: 50,
      ...
      autorestart: true,
      log_date_format: 'YYYY-MM-DD HH:mm:ss',
      error_file: path.join(LOG_DIR, 'polyedge-mirofish-error.log'),
      out_file: path.join(LOG_DIR, 'polyedge-mirofish-out.log'),
    },
  ],
};
