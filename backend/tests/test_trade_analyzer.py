...
def test_analyze_trade_missing_entry_price(analyzer, db_session):
    trade = create_test_trade(db_session, entry_price=None, settlement_value=1.0, size=100.0)
...
def test_analyze_trade_zero_quantity(analyzer, db_session):
    trade = create_test_trade(db_session, entry_price=0.50, settlement_value=1.0, size=0.0)
...
def test_analyze_trade_null_quantity(analyzer, db_session):
    trade = create_test_trade(db_session, entry_price=0.50, settlement_value=1.0, size=None)
...
def test_analyze_trade_history_single_trade(analyzer, db_session):
    trade = create_test_trade(db_session, entry_price=0.50, settlement_value=1.0, size=100.0)
...
def test_analyze_trade_history_with_outlier(analyzer, db_session):
    normal_trades = [
        create_test_trade(db_session, entry_price=0.50, settlement_value=0.51, size=100.0) for _ in range(5)
    ]

    outlier_trade = create_test_trade(db_session, entry_price=0.50, settlement_value=1.0, size=1000.0)
...
def test_analyze_trade_history_skip_invalid_trades(analyzer, db_session):
    valid_trade = create_test_trade(db_session, entry_price=0.50, settlement_value=1.0, size=100.0)

    invalid_trade_no_entry = create_test_trade(db_session, entry_price=None, settlement_value=1.0, size=100.0)

    invalid_trade_zero_size = create_test_trade(db_session, entry_price=0.50, settlement_value=1.0, size=0.0)
...
def test_analyze_trade_with_stored_pnl(analyzer, db_session):
    trade = create_test_trade(db_session, entry_price=0.50, settlement_value=1.0, size=100.0, pnl=15.0)
