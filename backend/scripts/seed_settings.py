...
DEFAULT_SETTINGS = {
    ...
    "SIGNAL_APPROVAL_MODE": (
        "manual",
        "Signal approval: manual, auto_approve, auto_deny",
    ),
    ...
    "WEBSEARCH_PROVIDER": (
        "tavily",
        "Web search provider: tavily, exa, serper, duckduckgo",
    ),
    ...
    "WEATHER_CITIES": (
        ...
        "Comma-separated weather cities",
    ),
    ...
    "PAPER_SLIPPAGE_BPS": (
        "20.0",
        "Paper slippage in basis points (0=disabled, 20=0.2%)",
    ),
    "PAPER_MIN_SLIPPAGE_BPS": (
        "5.0",
        "Minimum slippage in basis points regardless of base",
    ),
    "PAPER_SIZE_IMPACT_FACTOR": (
        "0.5",
        "Size impact factor — larger trades get more slippage",
    ),
    "PAPER_CLOB_FEE_RATE": (
        "0.02",
        "CLOB fee rate applied to paper trade profits (2%)",
    ),
    "PAPER_MIN_DEPTH_USD": (
        "100.0",
