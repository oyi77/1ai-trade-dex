...
DEFAULT_KELLY_FRACTION = settings.GENOME_KELLY_FRACTION
DEFAULT_MAX_POSITION_FRACTION = settings.GENOME_MAX_POSITION_FRACTION
DEFAULT_MAX_EXPOSURE_FRACTION = settings.GENOME_MAX_EXPOSURE_FRACTION
DEFAULT_MIN_CONFIDENCE = settings.GENOME_MIN_CONFIDENCE
