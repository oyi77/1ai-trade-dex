...
class ArbOpportunityScanner:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            "last_scan_opportunities": len(self._last_scan.opportunities) if self._last_scan else 0,
            "last_scan_duration_ms": self._last_scan.scan_duration_ms if self._last_scan else 0,
            "total_alerts": len(self._alerts),
            "high_severity_alerts": sum(1 for a in self._alerts if a.severity == "high"),
        }
