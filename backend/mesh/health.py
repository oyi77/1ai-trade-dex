...
SUCCESS_RATE_WINDOW = settings.MESH_SUCCESS_RATE_WINDOW
DEGRADED_SUCCESS_THRESHOLD = settings.MESH_DEGRADED_THRESHOLD
FAILED_SUCCESS_THRESHOLD = settings.MESH_FAILED_THRESHOLD
CONSECUTIVE_FAILURE_THRESHOLD = settings.MESH_CONSECUTIVE_FAILURE_THRESHOLD
RECOVERY_PROBE_INTERVAL = settings.MESH_RECOVERY_PROBE_INTERVAL
RECOVERY_SUCCESSES_NEEDED = settings.MESH_RECOVERY_SUCCESSES_NEEDED
